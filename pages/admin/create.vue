<template>
  <div class="relative mx-auto flex h-screen w-full max-w-[1560px] flex-col overflow-hidden">
    <ClientOnly>
      <div class="flex h-full flex-1">
        ...
        <Transition name="slide">
          <div
            class="right-column h-full overflow-auto w-[320px] border-l-[1px] border-gray-100 p-4 transition-all duration-300"
            v-show="showSetting"
          >
    ...
    <button
      @click="toggleSetting"
      class="hover: absolute bottom-5 right-5 flex h-12 w-12 items-center justify-center rounded-full bg-blue-500 text-white shadow-lg transition-all ease-in-out hover:scale-110 focus:scale-95"
    >
